...
class ActiviteitRepository extends \Doctrine\ORM\EntityRepository
{
    public function getBeschikbareActiviteiten($userid)
    {
        ...
        $query=$em->createQuery("SELECT a FROM App:Activiteit a WHERE :userid NOT MEMBER OF a.users AND a.datum >= :curdate  ORDER BY a.datum");
    ...
    public function getIngeschrevenActiviteiten($userid)
    {
        ...
        $em=$this->getEntityManager();
        $query=$em->createQuery("SELECT a FROM App:Activiteit a WHERE :userid MEMBER OF a.users AND a.datum >= :curdate ORDER BY a.datum");
